globalThis.ReaderI18n = (() => {
  const messages = {
    en: {
      ...
      settingsTitle: "Reading Settings", back: "Back", interfaceLanguage: "Interface language", autoDetect: "Automatically detect selected text language", showSelectionButton: "Show the on-page selection button",
      ...
      ocrLanguage: "Screen OCR language", speed: "Speed", pitch: "Pitch", volume: "Volume", saveSettings: "Save settings", testVoice: "Test voice", settingsSaved: "Settings saved",
    ...
    "zh-CN": {
      ...
      settingsTitle: "朗读设置", back: "返回", interfaceLanguage: "界面语言", autoDetect: "自动检测所选文字的语言", showSelectionButton: "显示网页选区按钮", fallbackLanguage: "备用语言", defaultVoice: "默认声音", automatic: "自动", voicesByLanguage: "各语言声音", chinese: "中文", english: "英文", japanese: "日文", korean: "韩文", useDefault: "使用默认声音",
      ocrLanguage: "屏幕 OCR 语言", speed: "语速", pitch: "音调", volume: "音量", saveSettings: "保存设置", testVoice: "试听声音", settingsSaved: "设置已保存",
    ...
    "zh-TW": {
      ...
      settingsTitle: "朗讀設定", back: "返回", interfaceLanguage: "介面語言", autoDetect: "自動偵測所選文字的語言", showSelectionButton: "顯示網頁選取按鈕", fallbackLanguage: "備用語言", defaultVoice: "預設聲音", automatic: "自動", voicesByLanguage: "各語言聲音", chinese: "中文", english: "英文", japanese: "日文", korean: "韓文", useDefault: "使用預設聲音",
      ocrLanguage: "螢幕 OCR 語言", speed: "語速", pitch: "音調", volume: "音量", saveSettings: "儲存設定", testVoice: "試聽聲音", settingsSaved: "設定已儲存",
    ...
    ja: {
      ...
      settingsTitle: "読み上げ設定", back: "戻る", interfaceLanguage: "表示言語", autoDetect: "選択したテキストの言語を自動検出", showSelectionButton: "ページ上に選択ボタンを表示", fallbackLanguage: "予備の言語", defaultVoice: "既定の音声", automatic: "自動", voicesByLanguage: "言語別の音声", chinese: "中国語", english: "英語", japanese: "日本語", korean: "韓国語", useDefault: "既定を使用",
      ocrLanguage: "画面 OCR の言語", speed: "速度", pitch: "音程", volume: "音量", saveSettings: "設定を保存", testVoice: "音声をテスト", settingsSaved: "設定を保存しました",
    ...
    ko: {
      ...
      settingsTitle: "읽기 설정", back: "뒤로", interfaceLanguage: "인터페이스 언어", autoDetect: "선택한 텍스트 언어 자동 감지", showSelectionButton: "페이지 선택 버튼 표시", fallbackLanguage: "대체 언어", defaultVoice: "기본 음성", automatic: "자동", voicesByLanguage: "언어별 음성", chinese: "중국어", english: "영어", japanese: "일본어", korean: "한국어", useDefault: "기본값 사용",
      ocrLanguage: "화면 OCR 언어", speed: "속도", pitch: "음높이", volume: "볼륨", saveSettings: "설정 저장", testVoice: "음성 테스트", settingsSaved: "설정이 저장되었습니다",
